"""GPU device selection and memory helpers."""
...
from vidore3_ablations.hardware.vram import VramProfile
...
def resolve_score_device(
    ...
    """Pick a device for MaxSim scoring that fits consumer GPU memory."""
    if preference != "auto":
